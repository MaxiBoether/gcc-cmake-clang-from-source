...
INSTALLDIR=/scratch/maximilian.boether/opt/gcc-ml-${GCC_VERSION}
BUILDDIR=/scratch/maximilian.boether/tmp/gcc-ml-${GCC_VERSION}_build
SOURCEDIR=/scratch/maximilian.boether/tmp/gcc-ml-${GCC_VERSION}_source
TARDIR=/scratch/maximilian.boether/tmp/gcc-ml-${GCC_VERSION}_tar
...
__wget https://ftp.mpi-inf.mpg.de/mirrors/gnu/mirror/gcc.gnu.org/pub/gcc/releases/gcc-${GCC_VERSION} gcc-ml-${GCC_VERSION}.tar.gz

# Check tarfiles are found, if not found, dont proceed
if [ ! -f "$TARDIR/gcc-ml-${GCC_VERSION}.tar.gz" ]; then
...
#======================================================================
__untar  "$SOURCEDIR"  "$TARDIR/gcc-ml-${GCC_VERSION}.tar.gz"

#======================================================================
# Download the prerequisites
#======================================================================
cd ${SOURCEDIR}/gcc-ml-${GCC_VERSION}
...
$SOURCEDIR/gcc-ml-${GCC_VERSION}/configure             \
    --prefix=${INSTALLDIR}                           \
    --enable-shared                                  \
...
# source this script to bring gcc-ml ${GCC_VERSION} into your environment
